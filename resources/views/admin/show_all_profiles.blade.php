                            ...
                            @foreach ($profiles as $profile)
                                @if ($profile->user->role < 1)
                                    <tr>
                                        ...
                                        <td><img src="{{ asset('uploads/profiles/' . $profile->profile_pic) }}"
                                                width="60px">
                                        </td>
                                        </td>
                                        <td><a target="_blank" href="tel:{{ $profile->phone }}"><svg
                                                    xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40"
                                                    height="40" viewBox="0 0 50 50" style=" fill:#4a90e2;">
                                                    <path
                                        ...
                                        <td><a target="_blank" href="mailto:{{ $profile->email }}"><img width="40"
                                                    height="40"
                                        ...
                                        <td><a target="_blank" href="{{ $profile->github }}"><svg
                                                    xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40"
                                                    height="40" viewBox="0 0 50 50" style=" fill:#4a90e2;">
                                                    <path
