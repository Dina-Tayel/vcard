                    ...
                    <tbody>
                        ...
                        @foreach ($profiles as $profile)
                            <tr>
                                ...
                                <td><img src="{{ asset('uploads/profiles/' . $profile->profile_pic) }}" width="60px"></td>
                                </td>
                                <td><a target="_blank" href="tel:{{ $profile->phone }}"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                    width="40" height="40"
                                    viewBox="0 0 50 50"
                                    style=" fill:#4a90e2;"><path d="M 14 3.9902344 C 8.4886661 3.9902344 4 8.4789008 4 13.990234 L 4 35.990234 C 4 41.501568 8.4886661 45.990234 14 45.990234 L 36 45.990234 C 41.511334 45.990234 46 41.501568 46 35.990234 L 46 13.990234 C 46 8.4789008 41.511334 3.9902344 36 3.9902344 L 14 3.9902344 z M 18.005859 12.033203 C 18.633859 12.060203 19.210594 12.414031 19.558594 12.957031 C 19.954594 13.575031 20.569141 14.534156 21.369141 15.785156 C 22.099141 16.926156 22.150047 18.399844 21.498047 19.589844 L 20.033203 21.673828 C 19.637203 22.237828 19.558219 22.959703 19.824219 23.595703 C 20.238219 24.585703 21.040797 26.107203 22.466797 27.533203 C 23.892797 28.959203 25.414297 29.761781 26.404297 30.175781 C 27.040297 30.441781 27.762172 30.362797 28.326172 29.966797 L 30.410156 28.501953 C 31.600156 27.849953 33.073844 27.901859 34.214844 28.630859 C 35.465844 29.430859 36.424969 30.045406 37.042969 30.441406 C 37.585969 30.789406 37.939797 31.366141 37.966797 31.994141 C 38.120797 35.558141 35.359641 37.001953 34.556641 37.001953 C 34.000641 37.001953 27.316344 37.761656 19.777344 30.222656 C 12.238344 22.683656 12.998047 15.999359 12.998047 15.443359 C 12.998047 14.640359 14.441859 11.879203 18.005859 12.033203 z"></path></svg></a></td>
                                <td><a target="_blank" href="mailto:{{ $profile->email }}"><img width="40" height="40"
                                            srcset="https://img.icons8.com/fluency/344/4a90e2/email-open.png 2x"
                                            alt="icon" loading="lazy"></a></td>
                                <td class="text-center"><a target="_blank" href="{{ $profile->fb }}"><svg
                                ...
                                <td class="text-center"><a target="_blank" href="{{ $profile->linkedin }}"><svg
                                            xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40"
                                            viewBox="0 0 50 50" style=" fill:#4a90e2;">
                                            <path
                                                d="M25,2C12.318,2,2,12.317,2,25s10.318,23,23,23s23-10.317,23-23S37.682,2,25,2z M18,35h-4V20h4V35z M16,17 c-1.105,0-2-0.895-2-2c0-1.105,0.895-2,2-2s2,0.895,2,2C18,16.105,17.105,17,16,17z M37,35h-4v-5v-2.5c0-1.925-1.575-3.5-3.5-3.5 S26,25.575,26,27.5V35h-4V20h4v1.816C27.168,20.694,28.752,20,30.5,20c3.59,0,6.5,2.91,6.5,6.5V35z">
                                            </path>
                                        </svg></a></td>
                                <td><a target="_blank" href="{{ $profile->github }}"><svg xmlns="http://www.w3.org/2000/svg" x="0px"
                                            y="0px" width="40" height="40" viewBox="0 0 50 50" style=" fill:#4a90e2;">
                                            <path
                                ...
                                <td>
                                    <a target="_blank" href="{{ url('profile/' . $user->username . '/' . $profile->profile_name) }}"
                                        class="btn btn-success "><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                        width="16" height="16"
                                        viewBox="0 0 40 40"
                                        style=" fill:#4a90e2;"><path fill="#8bb7f0" d="M6.5,37.5v-35H35c0.275,0,0.5,0.224,0.5,0.5v34c0,0.276-0.225,0.5-0.5,0.5H6.5z"></path><path fill="#4e7ab5" d="M35,3v34H7V3H35 M35,2H6v36h29c0.552,0,1-0.448,1-1V3C36,2.448,35.552,2,35,2L35,2z"></path><path fill="#4e7ab5" d="M9,38H5c-0.552,0-1-0.448-1-1V3c0-0.552,0.448-1,1-1h4V38z"></path><path fill="#fff" d="M22 12A4 4 0 1 0 22 20 4 4 0 1 0 22 12zM28 27c0-3.314-2.686-6-6-6-3.314 0-6 2.686-6 6H28z"></path></svg></a>
                                </td>
