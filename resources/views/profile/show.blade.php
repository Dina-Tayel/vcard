                        ...
                        <tbody>
                            @foreach ($userprofile as $data)
                                <tr>
                                    ...
                                    <td><a target="_blank" href="tel:{{ $data->phone }}"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                        width="40" height="40"
                                        viewBox="0 0 50 50"
                                    ...
                                    <td><a target="_blank" href="mailto:{{ $data->email }}"><img width="40" height="40"
                                                srcset="https://img.icons8.com/fluency/344/4a90e2/email-open.png 2x"
                                                alt="icon" loading="lazy"></a></td>
                                    <td class="text-center"><a target="_blank" href="{{ $data->fb }}"><svg
                                    ...
                                    <td class="text-center"><a target="_blank" href="{{ $data->linkedin }}"><svg
                                                xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40"
                                    ...
                                    <td><a target="_blank" href="{{ $data->github }}"><svg xmlns="http://www.w3.org/2000/svg" x="0px"
                                    ...
                                    <td>
                                        <a target="_blank" href="{{ url('profile/' . auth()->user()->username . '/' . $data->profile_name) }}"
                                    ...
                                    <td>
                                        <form method="POST" action="{{ route('userProfile.destroy', $data->id) }}">
                                            ...
                                            <button type="submit" class="btn btn-danger"
                                                onclick=" return confirm('Are You Really Want to delete');"> <svg xmlns="http://www.w3.org/2000/svg"
